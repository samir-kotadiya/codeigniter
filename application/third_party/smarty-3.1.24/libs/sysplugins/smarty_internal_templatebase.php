...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
    ...
    public function registerPlugin($type, $tag, $callback, $cacheable = true, $cache_attr = null)
    {
        ...
        if (isset($smarty->registered_plugins[$type][$tag])) {
            ...
            $smarty->registered_plugins[$type][$tag] = array(
                $callback,
                (bool) $cacheable,
                (array) $cache_attr
            );
     ...
     *            or instance of Smarty_Resource, or array of callbacks to handle resource
     *            (deprecated)
     *            
     * @return Smarty_Internal_Templatebase current Smarty_Internal_Templatebase (or Smarty or
     *         Smarty_Internal_Template) instance for chaining
    ...
    {
        $smarty = isset($this->smarty) ? $this->smarty : $this;
        $smarty->registered_resources[$type] = $callback instanceof Smarty_Resource ? $callback : array(
            $callback,
            false
        );
