		...
		<div class="form-panel">
			...
			?>
				...
				?>
				 ...
				 <div class="form-group col-sm-12">
				 	<div class="col-sm-2"><label class="col-sm-2 control-label"> </label></div>
				 	<div id="addeducation" class="col-sm-10  fields-group" >
				 	</div>	
				 </div>
				<?php
			}	
			...
			{	
				...
				<div class="form-group">
					...
					<div class="col-sm-2"> 
						<div class="col-sm-1"><button id="addeducationbtn" data-inc="1" data-template="education" type="button" class="addmorebtn btn btn-primary btn-xs"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add more</button></div>
					</div>
				</div>
				 <div class="form-group col-sm-12">
				 	<div class="col-sm-2"></div>
				 	<div id="addeducation" class="col-sm-7  fields-group" >
				 	</div>	
				 </div>
				...
				<div class="form-group">
					...
					<?php if($key != 0){?>
						...
						<?php }else{ ?>
						<div class="col-sm-2"> 
							<div class="col-sm-1"><button id="addmore" data-inc="<?php echo count($experience); ?>" data-template="experience" type="button" class="addmorebtn btn btn-primary btn-xs"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add more</button></div>
						</div>
				...
				?>
				 ...
				 <div class="form-group">
				 	<div class="col-sm-2"></div>
				 	<div id="addexperience" class="col-sm-8  fields-group" >
				 	</div>		
				 </div>
				<?php
			}
			...
			<div class="form-group">
					...
					<div class="col-sm-2"> 
						<div class="col-sm-1"><button id="addmore" data-inc="1" data-template="experience" type="button"  class="addmorebtn btn btn-primary btn-xs"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add more</button></div>
					</div>
				...
				<div class="form-group">
					...
					<div  class="col-sm-12 ">
						...
						<?php }else{ ?>
						<div class="col-sm-2"> 
							<div class="col-sm-1"><button id="addskillbtn" data-inc="<?php echo count($skills); ?>" data-template="skill" type="button" class="addmorebtn btn btn-primary btn-xs"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add more</button></div>
						</div>
				...
				?>
				 ...
				 <div class="form-group col-sm-12">
				 	<div class="col-sm-2"></div>
				 	<div id="addskill" class="col-sm-9  fields-group" >
				 	</div>		
				 </div>
				 <?php
				}
				...
				<div class="form-group">
					...
					<div class="col-sm-2"> 
						<div class="col-sm-1"><button id="addskillbtn" data-inc="1" data-template="skill" type="button" class="addmorebtn btn btn-primary btn-xs"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add more</button></div>
					</div>
				</div>
				 <div class="form-group col-sm-12">
				 	<div class="col-sm-2"></div>
