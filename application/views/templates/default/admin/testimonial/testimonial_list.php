			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="pull-right">
						<a href="<?php echo site_url('admin/testimonial/testimonial/add'); ?>"
				...
				<table class="table table-striped table-advance table-hover">
					<thead>
						<tr>
							...
							<th><?php sorting_link('name','content',''); ?></th>							
				...
				<?php foreach ($testimonial as $key=>$test){ ?>
					...
					?>
							<td><input type="checkbox" id="cb<?php echo $key+1; ?>" name="cid[]"
								value="<?php echo $test['id']; ?>" /></td>
							<td><a
								href="<?php echo site_url('admin/testimonial/testimonial/edit/id/'.$test['id']); ?>"><?php echo $test['content']; ?></a></td>
							
							
								
							<td><span class="label label-info label-mini"><?php echo $test['created_by']; ?></span></td>
							<td>
					...
					<div>
						<input type="hidden" name="frmaction"
							value="<?php echo site_url('admin/testimonial/testimonial'); ?>" />
