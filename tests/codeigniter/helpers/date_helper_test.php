...
class Date_helper_test extends CI_TestCase
{
    ...
    public function test_now_utc()
    {
         ...
         *
         */
        $this->assertEquals(mktime(gmdate('G'), gmdate('i'), gmdate('s'), gmdate('n'), gmdate('j'), gmdate('Y')), now('UTC'));
    }
    
    // ------------------------------------------------------------------------
    public function test_mdate()
    {
        $this->assertEquals(date('Y-m-d - h:i a', $this->time), mdate('%Y-%m-%d - %h:%i %a', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_rfc822()
    {
        $this->assertEquals(date(DATE_RFC822, $this->time), standard_date('DATE_RFC822', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_atom()
    {
        $this->assertEquals(date(DATE_ATOM, $this->time), standard_date('DATE_ATOM', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_cookie()
    {
        $this->assertEquals(date(DATE_COOKIE, $this->time), standard_date('DATE_COOKIE', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_iso8601()
    {
        $this->assertEquals(date(DATE_ISO8601, $this->time), standard_date('DATE_ISO8601', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_rfc850()
    {
        $this->assertEquals(date(DATE_RFC850, $this->time), standard_date('DATE_RFC850', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_rfc1036()
    {
        $this->assertEquals(date(DATE_RFC1036, $this->time), standard_date('DATE_RFC1036', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_rfc1123()
    {
        $this->assertEquals(date(DATE_RFC1123, $this->time), standard_date('DATE_RFC1123', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_rfc2822()
    {
        $this->assertEquals(date(DATE_RFC2822, $this->time), standard_date('DATE_RFC2822', $this->time));
    }
    
    // ------------------------------------------------------------------------
    public function test_standard_date_rss()
    {
        $this->assertEquals(date(DATE_RSS, $this->time), standard_date('DATE_RSS', $this->time));
    }
    ...
    {
        $this->assertEquals(mktime(gmdate('G', $this->time), gmdate('i', $this->time), gmdate('s', $this->time), gmdate('n', $this->time), gmdate('j', $this->time), gmdate('Y', $this->time)), local_to_gmt($this->time));
    }
