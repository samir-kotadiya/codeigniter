...
EOH;
        ...
        $this->assertEquals($expected, form_dropdown('cars', $options, array(
            'volvo',
            'audi'
        )));
    }
...
EOH;
        ...
        $this->assertEquals($expected, form_multiselect('shirts[]', $options, array(
            'med',
            'large'
        )));
    }
...
EOH;
    ...
    {
        $this->assertEquals('Here is a string containing &quot;quoted&quot; text.', form_prep('Here is a string containing "quoted" text.'));
        
        $this->assertEquals('Here is a string containing a &lt;tag&gt;.', form_prep('Here is a string containing a <tag>.', TRUE));
    }
}
