...
class standard_test extends CI_TestCase
{
    ...
    public function test_array_column()
    {
        ...
        $this->assertEquals(array(), array_column(array(
            'foo',
            'bar',
            'baz'
        ), 1));
