...
class password_test extends CI_TestCase
{
    ...
    public function test_password_hash()
    {
        ...
        if (! defined('MCRYPT_DEV_URANDOM') && ! function_exists('openssl_random_pseudo_bytes') && (DIRECTORY_SEPARATOR !== '/' or ! is_readable('/dev/arandom') or ! is_readable('/dev/urandom'))) {
        ...
        $this->assertEquals('$2y$07$usesomesillystringfore2uDLvp1Ii2e./U9C8sBjqp8I90dH6hi', password_hash('rasmuslerdorf', PASSWORD_BCRYPT, array(
            'cost' => 7,
            'salt' => 'usesomesillystringforsalt'
        )));
        
        $this->assertEquals('$2y$10$MTIzNDU2Nzg5MDEyMzQ1Nej0NmcAWSLR.oP7XOR9HD/vjUuOj100y', password_hash('test', PASSWORD_BCRYPT, array(
    ...
    public function test_password_needs_rehash()
    {
        ...
        $this->assertFalse(password_needs_rehash('$2y$10$MTIzNDU2Nzg5MDEyMzQ1Nej0NmcAWSLR.oP7XOR9HD/vjUuOj100y', PASSWORD_BCRYPT, array(
            'cost' => 10
        )));
        ...
        $this->assertTrue(password_needs_rehash('$2y$10$MTIzNDU2Nzg5MDEyMzQ1Nej0NmcAWSLR.oP7XOR9HD/vjUuOj100y', PASSWORD_BCRYPT, array(
            'cost' => 9
        )));
