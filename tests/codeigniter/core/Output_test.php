...
HTML;
    ...
    public function test_set_get_append_output()
    {
        ...
        $this->assertEquals($this->_output_data . $append, $this->output->set_output($this->_output_data)
    ...
    public function test_get_header()
    {
        ...
        $this->assertEquals('text/plain; charset=WINDOWS-1251', $this->output->get_header('content-type'));
    }
}
