...
class Encryption_test extends CI_TestCase
{
    ...
    public function test_hkdf()
    {
        ...
        foreach ($vectors as $test) {
            $this->assertEquals($test['okm'], $this->encryption->hkdf($test['ikm'], $test['digest'], $test['salt'], $test['length'], $test['info']));
        }
    ...
    public function test_encrypt_decrypt_custom()
    {
        ...
        $this->assertFalse($this->encryption->encrypt($message, array(
            'foo'
        )));
        $this->assertFalse($this->encryption->decrypt($message, array(
            'foo'
        )));
    ...
    public function test_magic_get()
    {
        ...
        $this->assertEquals(array(
            'mcrypt',
            'openssl'
        ), array_keys($this->encryption->drivers));
