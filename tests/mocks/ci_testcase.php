...
class CI_TestCase extends PHPUnit_Framework_TestCase
{
     ...
     * @param
     *            object Optional root to create in
     ...
     *            string File content
     * @param
     *            object VFS directory object
     * @param
     *            mixed Optional subdirectory path or array of subs
     * @return void
     */
     ...
     *
     * @param
     *            string Path from base directory
